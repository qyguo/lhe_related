...
#        print "end of file reached. no new weights found"
    ...
    for k in wgt_id: # one histo per weight class
        ...
        m_Z[k]  = ROOT.TH1F('m_Z_'+label , 'm_Z_'+label ,20, 40, 140)
        pT_Z[k]  = ROOT.TH1F('pT_Z_'+label , 'pT_Z_'+label , 40, 0, 200)
        m_2l[k]  = ROOT.TH1F('m_2l_'+label , 'm_2l_'+label ,30, 0, 150)
        pT_2l[k] = ROOT.TH1F('pT_2l_'+label , 'pT_2l_'+label , 40, 0, 200)
        pT_l[k] = ROOT.TH1F('pT_l_'+label , 'pT_l_'+label , 40, 0, 200)
